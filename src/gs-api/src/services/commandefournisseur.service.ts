...
class CommandefournisseurService extends __BaseService {
  ...
  /**
   * @param params The `CommandefournisseurService.DeleteProduitParams` containing the following parameters:
   *
   * - `idLigneCommande`:
   *
   * - `idCommande`:
   ...
   * @return successful operation
   */
  deleteProduitResponse(params: CommandefournisseurService.DeleteProduitParams): __Observable<__StrictHttpResponse<CommandeFournisseurDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return successful operation
   */
  deleteProduit(params: CommandefournisseurService.DeleteProduitParams): __Observable<CommandeFournisseurDto> {
